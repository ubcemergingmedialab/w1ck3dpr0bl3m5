...
class MemMenu implements ActionListener, MenuExtender
{
    ...
    MemMenu(SimpleRam factory, Instance instance) {
	...
	int choice = JOptionPane.showConfirmDialog(frame, "Are you sure you wish to zero out the memory?", "Confirm Clear", JOptionPane.YES_NO_OPTION);
	...
	if (choice == JFileChooser.APPROVE_OPTION) {
		...
		JOptionPane.showMessageDialog(frame, e.getMessage(), "Load Error", JOptionPane.ERROR_MESSAGE);
	    }
	}
    }
